...
app.get('/', (c) => {
  return c.html(`
    ...
    <head>
        ...
        <link rel="icon" type="image/svg+xml" href="/static/favicon.svg">
        <link href="/static/styles.css?v=FINAL" rel="stylesheet">
        <link href="/static/chatbot.css?v=FINAL" rel="stylesheet">
        <link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet">
        <style>
            /* 명품 라이프스타일 커스텀 색상 */
            :root {
    ...
    <body>
        ...
        <main style="max-width: 900px; margin: 0 auto; padding: 8px 24px 80px 24px;">
            ...
            <!-- Notice Modal -->
            <div id="noticeSection" style="position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.5); z-index: 9999; display: none; align-items: center; justify-content: center; padding: 16px;">
        ...
        <div id="chatbotWindow" class="chatbot-window hidden">
            <!-- 헤더 -->
            <div class="chatbot-header" style="background: linear-gradient(135deg, #FF6B35 0%, #FF8C5A 100%); padding: 12px 16px; display: flex; justify-content: space-between; align-items: center;">
                <div style="display: flex; align-items: center; gap: 12px; flex: 1; min-width: 0;">
                    <div style="width: 36px; height: 36px; background: rgba(255,255,255,0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 18px; flex-shrink: 0;">
                        <i class="fas fa-robot" style="color: white;"></i>
                    </div>
                    <div style="flex: 1; min-width: 0;">
                        <h3 id="chatbotTitle" style="font-size: 15px; font-weight: 600; margin: 0; color: white; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">DietMed 케어봇</h3>
                        <span style="font-size: 11px; display: flex; align-items: center; gap: 4px; opacity: 0.9; color: white;">
                ...
                <div style="display: flex; align-items: center; gap: 6px; flex-shrink: 0;">
                    <!-- 언어 버튼 -->
                    <button class="lang-btn active" data-lang="ko" title="한국어" style="width: 26px; height: 26px; border: none; background: rgba(255,255,255,0.2); border-radius: 6px; cursor: pointer; font-size: 13px; flex-shrink: 0;">🇰🇷</button>
                    <button class="lang-btn" data-lang="en" title="English" style="width: 26px; height: 26px; border: none; background: rgba(255,255,255,0.2); border-radius: 6px; cursor: pointer; font-size: 13px; flex-shrink: 0;">🇺🇸</button>
                    <button class="lang-btn" data-lang="zh" title="中文" style="width: 26px; height: 26px; border: none; background: rgba(255,255,255,0.2); border-radius: 6px; cursor: pointer; font-size: 13px; flex-shrink: 0;">🇨🇳</button>
                    <button class="lang-btn" data-lang="ja" title="日本語" style="width: 26px; height: 26px; border: none; background: rgba(255,255,255,0.2); border-radius: 6px; cursor: pointer; font-size: 13px; flex-shrink: 0;">🇯🇵</button>
                    
                    <!-- X 닫기 버튼 - 크고 명확하게 -->
                    <button id="closeChatbot" style="width: 44px; height: 44px; background: white; color: #FF6B35; font-size: 28px; font-weight: bold; border: none; border-radius: 8px; cursor: pointer; display: flex; align-items: center; justify-content: center; box-shadow: 0 2px 8px rgba(0,0,0,0.3); flex-shrink: 0; margin-left: 4px;">✖</button>
                </div>
            </div>
        ...
        <script src="https://cdn.jsdelivr.net/npm/axios@1.6.0/dist/axios.min.js"></script>
        <script src="/static/app.js?v=FINAL"></script>
        <script src="/static/chatbot-data.js?v=FINAL"></script>
        <script src="/static/chatbot.js?v=FINAL"></script>
    </body>
    </html>
  `);
});
...
// HTML Pages
const noticesHTML = `<!DOCTYPE html><html lang="ko"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>공지사항</title><script src="https://cdn.tailwindcss.com"></script><link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet"></head><body class="bg-gray-100 p-4"><div class="max-w-4xl mx-auto"><div class="bg-white rounded-2xl shadow-xl p-8 mb-6"><div class="flex items-center justify-between"><div class="flex items-center gap-4"><div class="p-3 bg-orange-100 rounded-full"><i class="fas fa-bullhorn text-3xl text-orange-500"></i></div><div><h1 class="text-3xl font-bold text-gray-800">공지사항</h1><p class="text-gray-600">DietMed Global</p></div></div><button onclick="window.close()" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-lg"><i class="fas fa-times mr-2"></i>닫기</button></div></div><div class="space-y-4"><div class="bg-white rounded-xl shadow p-6"><h3 class="text-xl font-semibold text-gray-800 mb-2">🎉 DietMed Global 서비스 오픈</h3><p class="text-gray-600 mb-3">다이어트 약물의 안전성과 효과를 검증하는 플랫폼이 정식으로 오픈되었습니다.</p><div class="flex gap-4 text-sm text-gray-500"><span><i class="fas fa-calendar mr-1"></i>2025.12.20</span><span><i class="fas fa-eye mr-1"></i>1,245회</span></div></div><div class="bg-white rounded-xl shadow p-6"><h3 class="text-xl font-semibold text-gray-800 mb-2">💊 Wegovy 안전성 정보 업데이트</h3><p class="text-gray-600 mb-3">Wegovy 관련 최신 안전성 정보가 업데이트되었습니다.</p><div class="flex gap-4 text-sm text-gray-500"><span><i class="fas fa-calendar mr-1"></i>2025.12.18</span><span><i class="fas fa-eye mr-1"></i>892회</span></div></div><div class="bg-white rounded-xl shadow p-6"><h3 class="text-xl font-semibold text-gray-800 mb-2">🌍 다국어 지원 서비스 확대</h3><p class="text-gray-600 mb-3">DietMed Global이 6개 언어 지원을 시작합니다!</p><div class="flex gap-4 text-sm text-gray-500"><span><i class="fas fa-calendar mr-1"></i>2025.12.15</span><span><i class="fas fa-eye mr-1"></i>634회</span></div></div><div class="bg-white rounded-xl shadow p-6"><h3 class="text-xl font-semibold text-gray-800 mb-2">🤖 AI 챗봇 FAQ 25개 항목 추가</h3><p class="text-gray-600 mb-3">챗봇 서비스가 대폭 강화되었습니다!</p><div class="flex gap-4 text-sm text-gray-500"><span><i class="fas fa-calendar mr-1"></i>2025.12.10</span><span><i class="fas fa-eye mr-1"></i>1,567회</span></div></div></div></div></body></html>`;

const loginHTML = `<!DOCTYPE html><html lang="ko"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>로그인</title><script src="https://cdn.tailwindcss.com"></script><link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet"></head><body class="bg-gray-100 flex items-center justify-center min-h-screen p-4"><div class="bg-white rounded-2xl shadow-xl max-w-md w-full p-8"><div class="text-center mb-8"><div class="inline-block p-3 bg-orange-100 rounded-full mb-4"><i class="fas fa-sign-in-alt text-3xl text-orange-500"></i></div><h1 class="text-3xl font-bold text-gray-800 mb-2">로그인</h1><p class="text-gray-600">DietMed Global</p></div><form class="space-y-6"><div><label class="block text-sm font-medium text-gray-700 mb-2"><i class="fas fa-envelope mr-2"></i>이메일</label><input type="email" required class="w-full px-4 py-3 border border-gray-300 rounded-lg" placeholder="your@email.com"></div><div><label class="block text-sm font-medium text-gray-700 mb-2"><i class="fas fa-lock mr-2"></i>비밀번호</label><input type="password" required class="w-full px-4 py-3 border border-gray-300 rounded-lg" placeholder="••••••••"></div><button type="submit" class="w-full bg-orange-500 text-white py-3 rounded-lg font-semibold hover:bg-orange-600"><i class="fas fa-sign-in-alt mr-2"></i>로그인</button></form><div class="mt-6 text-center"><p class="text-gray-600">계정이 없으신가요? <a href="/register" class="text-orange-500">회원가입</a></p></div></div></body></html>`;

const registerHTML = `<!DOCTYPE html><html lang="ko"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>회원가입</title><script src="https://cdn.tailwindcss.com"></script><link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet"></head><body class="bg-gray-100 flex items-center justify-center min-h-screen p-4"><div class="bg-white rounded-2xl shadow-xl max-w-md w-full p-8"><div class="text-center mb-8"><div class="inline-block p-3 bg-orange-100 rounded-full mb-4"><i class="fas fa-user-plus text-3xl text-orange-500"></i></div><h1 class="text-3xl font-bold text-gray-800 mb-2">회원가입</h1><p class="text-gray-600">DietMed Global</p></div><form class="space-y-5"><div><label class="block text-sm font-medium text-gray-700 mb-2"><i class="fas fa-user mr-2"></i>이름</label><input type="text" required class="w-full px-4 py-3 border border-gray-300 rounded-lg" placeholder="홍길동"></div><div><label class="block text-sm font-medium text-gray-700 mb-2"><i class="fas fa-envelope mr-2"></i>이메일</label><input type="email" required class="w-full px-4 py-3 border border-gray-300 rounded-lg" placeholder="your@email.com"></div><div><label class="block text-sm font-medium text-gray-700 mb-2"><i class="fas fa-lock mr-2"></i>비밀번호</label><input type="password" required minlength="8" class="w-full px-4 py-3 border border-gray-300 rounded-lg" placeholder="••••••••"><p class="text-xs text-gray-500 mt-1">8자 이상</p></div><button type="submit" class="w-full bg-orange-500 text-white py-3 rounded-lg font-semibold hover:bg-orange-600"><i class="fas fa-user-plus mr-2"></i>회원가입</button></form><div class="mt-6 text-center"><p class="text-gray-600">이미 계정이 있으신가요? <a href="/login" class="text-orange-500">로그인</a></p></div></div></body></html>`;

// Both /notices.html and /notices
app.get('/notices.html', (c) => c.html(noticesHTML));
app.get('/notices', (c) => c.html(noticesHTML));

// Both /login.html and /login
app.get('/login.html', (c) => c.html(loginHTML));
app.get('/login', (c) => c.html(loginHTML));

// Both /register.html and /register
